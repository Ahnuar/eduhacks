            ...
            <?php
              ...
              if($tenemosreto){
                foreach($retosgenerales as $reto){
                    ...
                    echo     '<p>PDF RANDOM</p>';
                    echo     '<h6>Flag</h6>';  
                    echo     '<i><p class="flag">Esto es una prueba de flag</p></i>';    
                    echo    '<div class="d-flex justify-content-between align-items-center">';
                    echo     '<div class="btn-group">';
                    echo     '<button onclick="location.href = \'./lib/challengs.php\';" type="button" class="btn btn-sm btn-outline-secondary"   >Submit</button>';
